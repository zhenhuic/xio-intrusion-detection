...
"color: rgb(255, 255, 255);")
        ...
        self.sendEmailRecord = QtWidgets.QAction(StatisticsWindow)
        self.sendEmailRecord.setObjectName("sendEmailRecord")
        ...
        self.notificationMenu.addAction(self.sendEmailRecord)
    ...
    def retranslateUi(self, StatisticsWindow):
        ...
        self.sendEmailRecord.setText(_translate("StatisticsWindow", "发送邮件报告"))
