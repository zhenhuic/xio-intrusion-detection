...
"color: rgb(85, 255, 255);")
        ...
        self.comboBox.setStyleSheet("background-color: rgb(35, 35, 35);\n"
"font: 11pt \"宋体\";\n"
"color: rgb(85, 255, 255);")
...
"color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, StatisticsWindow):
        ...
        self.comboBox.setItemText(0, _translate("StatisticsWindow", "一小时以内"))
        self.comboBox.setItemText(1, _translate("StatisticsWindow", "半天以内"))
        self.comboBox.setItemText(2, _translate("StatisticsWindow", "一天以内"))
        self.comboBox.setItemText(3, _translate("StatisticsWindow", "一周以内"))
        self.comboBox.setItemText(4, _translate("StatisticsWindow", "半个月以内"))
        self.comboBox.setItemText(5, _translate("StatisticsWindow", "一个月以内"))
